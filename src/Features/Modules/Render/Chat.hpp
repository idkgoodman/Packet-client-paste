...
public:
    ...
    void addMessage(std::string message, bool isError = false);
...
private:
    ...
    struct ChatMessage {
        ...
        float mLifeTime;
        float mPercent;
        bool isError = false;  // Флаг для сообщений об ошибках
    };
...
static const std::unordered_map<char, ImU32> colorMap = {
    ...
    {'r', IM_COL32(255, 255, 255, 255)},  // Для сброса цвета
};
...
// Класс для управления анимацией и визуалом чата
class GuiData {
public:
