...
public:
    ...
    EnumSettingT<ColorTheme> mMode = EnumSettingT<ColorTheme>("Theme", "The mode of the interface.", randomTheme, "Trans", "Rainbow", "Bubblegum", "Watermelon", "Sunset", "Poison", "Sky", "Custom");
    ...
    Interface() : ModuleBase("Interface", "Customize the visuals!", ModuleCategory::Render, 0, true) {
...
{Sky, {
    ImColor(255, 255, 100, 255);  // Светлый желтый
    ImColor(100, 255, 100, 255);  // Зеленый оттенок
    ImColor(0, 200, 255, 255);    // Сине-голубой
    ImColor(150, 100, 255, 255);  // Фиолетовый оттенок
}},
{Sunrise, {
    ImColor(255, 140, 70, 255);  // Яркий оранжево-розовый
    ImColor(255, 120, 90, 255); // Более темный розовато-оранжевый
{Custom,    {
    };
