...
class OreBreaker : public ModuleBase<OreBreaker> {
public:
    ...
    OreBreaker() : ModuleBase("OreBreaker", "Automatically breaks ores", ModuleCategory::Player, 0, false) {
        ...
        mNames = {
            {Lowercase, "orebreaker"},
            {LowercaseSpaced, "ore breaker"},
            {Normal, "OreBreaker"},
            {NormalSpaced, "Ore Breaker"}
        };
    }
