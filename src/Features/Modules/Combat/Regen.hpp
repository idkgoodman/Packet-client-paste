...
#include "imgui.h"
#include "glm/glm.hpp"
#include "Utils/MiscUtils/ImRenderUtils.hpp" // Для добавления размытия и теней
#include "Utils/MiscUtils/ColorUtils.hpp" // Для получения цвета темы
...
public:
    ...
    Regen() : ModuleBase("Regen", "Automatically breaks redstone", ModuleCategory::Combat, 0, false) {
        addSettings(
            &mProgressBarStyle,
            &mOffset,
            &mRenderProgressBar,
